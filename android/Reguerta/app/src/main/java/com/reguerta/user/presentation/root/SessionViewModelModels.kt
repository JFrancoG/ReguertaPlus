...
data class ProductDraft(
    ...
    val packContainerQty: String = "1",
    val weightStep: String = "0.5",
    val minWeight: String = "0.5",
    val maxWeight: String = "3",
    val isAvailable: Boolean = true,
    val stockMode: ProductStockMode = ProductStockMode.FINITE,
...
data class SessionUiState(
    ...
    val isUploadingSharedProfileImage: Boolean = false,
