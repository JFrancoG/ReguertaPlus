...
enum AccessL10nKey {
    ...
    static let signOutConfirmTitle = "access.action.sign_out.confirm.title"
    static let signOutConfirmMessage = "access.action.sign_out.confirm.message"
    ...
    static let commonCancel = "common.action.cancel"
    ...
    static let homeShellActionSendExtraNotification = "home.shell.action.send_extra_notification"
    ...
    static let homePlaceholderReadyMessage = "home.placeholder.ready_message"
    static let homePlaceholderBackHome = "home.placeholder.back_home"
    static let homePlaceholderMyOrdersHistoryNote = "home.placeholder.my_orders.history_note"
    static let homePlaceholderReceivedOrdersHistoryNote = "home.placeholder.received_orders.history_note"
    static let homePlaceholderSettingsIntro = "home.placeholder.settings.intro"
