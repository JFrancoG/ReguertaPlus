...
enum AccessL10nKey {
    ...
    static let startupValidationTimedOutTitle = "startup.validation.timed_out.title"
    static let startupValidationTimedOutMessage = "startup.validation.timed_out.message"
    static let startupValidationUnavailableTitle = "startup.validation.unavailable.title"
    static let startupValidationUnavailableMessage = "startup.validation.unavailable.message"
    ...
    static let imageSourceActionCamera = "image.source.action.camera"
    ...
    static let homeShellActionBylaws = "home.shell.action.bylaws"
    static let homeShellActionNews = "home.shell.action.news"
    ...
    static let homeDashboardProducer = "home.dashboard.producer"
    static let homeDashboardDelivery = "home.dashboard.delivery"
    static let homeDashboardResponsible = "home.dashboard.responsible"
    static let homeDashboardDeliveryResponsibles = "home.dashboard.delivery_responsibles"
    static let homeDashboardMarket = "home.dashboard.market"
    ...
    static let authErrorSessionData = "auth_error.session_data"
    ...
    static let feedbackCameraPermissionRequired = "feedback.camera_permission_required"
    ...
    static let feedbackShiftSwapConflict = "feedback.shift_swap_conflict"
    static let feedbackShiftSwapInvalidData = "feedback.shift_swap_invalid_data"
    static let feedbackShiftSwapNoCandidates = "feedback.shift_swap_no_candidates"
    static let feedbackShiftSwapPermissionDenied = "feedback.shift_swap_permission_denied"
    static let feedbackShiftSwapUnavailable = "feedback.shift_swap_unavailable"
    ...
    static let newsSaveCreatedDialogTitle = "news.save.created_dialog.title"
    static let newsSaveCreatedDialogMessage = "news.save.created_dialog.message"
    static let newsSaveUpdatedDialogTitle = "news.save.updated_dialog.title"
    static let newsSaveUpdatedDialogMessage = "news.save.updated_dialog.message"
...
extension AccessL10nKey {
    static let bylawsTitle = "bylaws.title"
    static let bylawsSubtitle = "bylaws.subtitle"
    static let bylawsInputLabel = "bylaws.input.label"
    static let bylawsInputPlaceholder = "bylaws.input.placeholder"
    ...
    static let bylawsSummaryTitle = "bylaws.summary.title"
    static let bylawsSummaryDisclaimer = "bylaws.summary.disclaimer"
    static let bylawsEvidenceTitle = "bylaws.evidence.title"
    static let bylawsEvidencePagesFormat = "bylaws.evidence.pages.format"
    static let bylawsPdfOnlyMessage = "bylaws.pdf_only.message"
    static let bylawsQuestionUnrelated = "bylaws.question.unrelated"
    static let bylawsEvidenceInsufficient = "bylaws.evidence.insufficient"
    static let bylawsSummaryGenerationFailed = "bylaws.summary.generation_failed"
    static let bylawsDevelopDetailsTitle = "bylaws.develop_details.title"
    static let bylawsDiagnosticsModelFormat = "bylaws.diagnostics.model.format"
    static let bylawsDiagnosticsRetrievalFormat = "bylaws.diagnostics.retrieval.format"
    static let bylawsQueryRequired = "bylaws.query.required"
