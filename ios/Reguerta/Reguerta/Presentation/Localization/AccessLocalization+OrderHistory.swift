...
extension AccessL10nKey {
    ...
    static let receivedOrdersTitle = "received_orders.title"
    ...
    static let receivedOrdersWindowClosedTitle = "received_orders.window_closed.title"
    static let receivedOrdersWindowClosedBody = "received_orders.window_closed.body"
    static let receivedOrdersEmptyTitle = "received_orders.empty.title"
    static let receivedOrdersEmptyBodyFormat = "received_orders.empty.body_format"
    ...
    static let receivedOrdersStatusPermissionDenied = "received_orders.status.permission_denied"
    static let receivedOrdersStatusFailure = "received_orders.status.failure"
