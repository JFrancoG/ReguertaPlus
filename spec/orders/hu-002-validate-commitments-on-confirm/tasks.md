# Tasks - HU-002 (Validate commitments on confirm)
...
## 4. Backend / Firestore
- [x] Adjust schema/queries/rules/functions where applicable. (N/A in this HU: no order persistence submission implemented yet)
