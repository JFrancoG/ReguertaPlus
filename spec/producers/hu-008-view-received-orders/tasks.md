# Tasks - HU-008 (View received orders)
...
## 4. Backend / Firestore
- [x] Adjust schema/queries/rules/functions where applicable. (No backend write changes required; HU-008 reads producer-scoped `orderlines` data model already produced by order checkout flow.)
