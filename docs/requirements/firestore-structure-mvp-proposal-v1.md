...
- Add optional fields gradually, including `users.emailNormalized`, nullable `users.authUid`, `users.lastDeviceId`, `products.unitAbbreviation`, `products.packContainerAbbreviation`, and `products.ecoBasketOption`.
