...
- Dado un envío de notificaciones, cuando se resuelven destinatarios, entonces se usan los dispositivos registrados en `users/{userId}/devices`, separando `fcmToken` para registros legacy/iOS y `firebaseInstallationId` para Android.
